...
class ShortUrlsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create short_url" do
    assert_difference('ShortUrl.count') do
      post short_urls_url, params: { short_url: { link: @short_url.link, short_link: @short_url.short_link } }
    end
  ...
  test "should update short_url" do
    patch short_url_url(@short_url), params: { short_url: { link: @short_url.link, short_link: @short_url.short_link } }
